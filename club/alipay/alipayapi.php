...
/**************************请求参数**************************/
        ...
        $notify_url = "$host/notify_url.php";
		...
		$return_url = "$host/return_url.php";
        //需http://格式的完整路径，不允许加?id=123这类自定义参数
        ...
        //订单名称
        $subject = "pay nyipcn";//$_POST['WIDsubject'];
        //必填
        ...
        //收货人姓名
        $receive_name ="";// urldecode($_GET['receive_name']);
        //如：张三

        //收货人地址
        $receive_address ="";// urldecode($_GET['receive_address']);

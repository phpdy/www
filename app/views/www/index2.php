...
<div id="index_main">
  ...
  <div class="index_channel">
	  <div style="width:632px;bgcolor:#1b559d">
		  <div>最新消息</div>
			<?php 
			foreach ($newlist as $key=>$item){
				echo "<div><a href='?control=detail&tid=60&pid=$item[catid]&id=$item[id]'>$item[title]</a>";
				echo date("Y-m-d H:m:i",$item['inputtime'])  ;
				echo "</div><div style='bgcolor:#afd2f9'>&nbsp;</div>" ;
			}
			?>
	  </div>
	  <div style="width:304px;bgcolor:#1b559d">
		  <div >关于纽摄教育 <a href="?control=ours">更多</a></div>
		  <div>纽约摄影学院中国学员班成立于2005年，目的在于向更多中国专业摄影师及爱好者推广纽约摄影学院著名的远程互动式全科专业摄影课程。纽约摄影学院全科专业摄影课程的主要作者、纽约摄影学院名誉院长、Home Study School现任院长唐·谢夫先生，经由纽约摄影学院授权，亲自负责监督并独家授权北京纽摄教育科技有限公司在中国汉化并教授这套专业摄影课程。</div>
	  </div>
  </div>
  <div class="index_channel">
  <?php 
...
<script type="text/javascript">var _py = _py || [];_py.push(['a', 'iX..VjU1WdnqRisNwo-QJRj8lP']);_py.push(['domain','stats.ipinyou.com']);_py.push(['e','']);-function(d) {var s = d.createElement('script'),e = d.body.getElementsByTagName('script')[0]; e.parentNode.insertBefore(s, e),f = 'https:' == location.protocol;s.src = (f ? 'https' : 'http') + '://'+(f?'fm.ipinyou.com':'fm.p0y.cn')+'/j/adv.js';}(document);</script><noscript><img src="//stats.ipinyou.com/adv.gif?a=iX..VjU1WdnqRisNwo-QJRj8lP&e=" style="display:none;"/></noscript>

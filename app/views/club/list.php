		...
		<div class="mainc_title"><?php echo $title1 ; ?></div>
			...
			if(!empty($list)){?>
				...
				foreach ($list as $news){
					...
					?>
					<ul>
						<a href="index.php?control=news&t=<?php echo $t;?>&id=<?php echo $id;?>">
...
//		alert(p) ;
		...
		$.get("./index.php",{control:"json", t:<?php echo $t;?>, p:p},
			function(result){
//			alert(result) ;
			...
			for(var i=0;i<list.length;i++){
				var item = list[i] ;
				var html = "<ul>"+
				"<a href='index.php?control=news&t=<?php echo $t;?>&id="+item["id"]+"'>"+
				"<li class='shey_img'><img src='"+item["thumb"]+"'  alt='more'/></li>"+

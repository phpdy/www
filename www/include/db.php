<?php
/*
$link = mysql_connect('localhost', 'gpuser', 'GpSogou1234');
if (!$link) {
  die('Could not connect: ' . mysql_error());
} else {
  mysql_select_db('phpcms', $link) or die ('Can\'t use foo : ' . mysql_error());
}
*/
...
class DBConfig {
    ...
    function conn($host='localhost',$user='gpuser',$pass='GpSogou1234',$db='phpcms'){ // connection function
        $this->host = $host;
        $this->user = $user;
        $this->pass = $pass;
        $this->db = $db;
